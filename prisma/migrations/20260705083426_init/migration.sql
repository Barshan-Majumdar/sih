-- CreateEnum
CREATE TYPE "ProjectRole" AS ENUM ('GC_OWNER', 'TRADE');

-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('NOT_STARTED', 'IN_PROGRESS', 'DONE', 'DELAYED');

-- CreateEnum
CREATE TYPE "RoadblockStatus" AS ENUM ('OPEN', 'RESOLVED');
...
-- AddForeignKey
ALTER TABLE "task" ADD CONSTRAINT "task_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "project_member"("id") ON DELETE SET NULL ON UPDATE CASCADE;
